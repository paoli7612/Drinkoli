    ...
    <div class="w3-panel w3-green w3-card-4 w3-round-large">
        <div class="w3-panel">
            <form action="sing-up" method="post">
                <input name="email" class="w3-input w3-round-large w3-margin-bottom" type="email" placeholder="Email" required autofocus>
                <input name="username" class="w3-input w3-round-large w3-margin-bottom" type="text" placeholder="Username" required>
